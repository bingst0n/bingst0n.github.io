...
export default function Home() {
  return (
    <div className="relative">
      {/* Decorative graphics - absolute positioning */}
      <div className="pointer-events-none absolute inset-0 z-0">
        ...
        <Image
          ...
          width={200}
          height={200}
          className="absolute opacity-25 drift-slower select-none glow-soft hidden landscape:block" style={{top: '150vh', left: '1vw', width: 'clamp(100px, 15vw, 240px)', height: 'auto'}}
          priority={false}
        />
        <Image
          ...
          width={240}
          height={240}
          className="absolute opacity-25 drift-slow select-none glow-soft hidden landscape:block" style={{top: '200vh', right: '1vw', width: 'clamp(120px, 18vw, 280px)', height: 'auto'}}
          priority={false}
        />
        <div className="absolute" style={{top: '250vh', left: '50%', transform: 'translateX(-50%)'}}>
          <Image
      ...
      {/* Hero Section - Higher up with padding */}
      <section id="home" className="relative pt-20 pb-16">
        <div className="text-center">
          ...
          <div className="mt-8 flex flex-wrap gap-4 justify-center">
            <a href="#projects" className="inline-flex items-center rounded-full bg-white/10 px-5 py-2.5 text-white/90 hover:bg-white/15 border border-white/15 transition-colors">
              Projects & Skills
            </a>
            <a href="#about" className="inline-flex items-center rounded-full bg-white/10 px-5 py-2.5 text-white/90 hover:bg-white/15 border border-white/15 transition-colors">
              About
            </a>
            <a href="#contact" className="inline-flex items-center rounded-full bg-white/10 px-5 py-2.5 text-white/90 hover:bg-white/15 border border-white/15 transition-colors">
              Contact
            </a>
          </div>
        </div>
      ...
      <section id="projects" className="relative space-y-16 pt-20 pb-16 scroll-mt-20">
        <div className="space-y-4">
          <h2 className="text-4xl sm:text-5xl font-bold text-white/95">
        ...
        <div className="space-y-6">
          <div>
            ...
            <h3 className="text-3xl font-bold text-white/95">Mathematics</h3>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <article className="bg-white/5 border border-white/10 backdrop-blur rounded-xl p-5">
              <h4 className="font-semibold text-lg text-white/90">Constructing Integer Lengths</h4>
            ...
            <article className="bg-white/5 border border-white/10 backdrop-blur rounded-xl p-5">
              <h4 className="font-semibold text-lg text-white/90">Forward & Backward Propagation</h4>
              <p className="text-white/70 text-sm mt-2">
            ...
            <article className="bg-white/5 border border-white/10 backdrop-blur rounded-xl p-5">
              <h4 className="font-semibold text-lg text-white/90">Ongoing Research</h4>
              <p className="text-white/70 text-sm mt-2">
        ...
        <div className="space-y-6">
          <div>
            <div className="text-xs uppercase tracking-wider text-white/60 mb-1">Discipline</div>
            <h3 className="text-3xl font-bold text-white/95">AI & Coding</h3>
            <p className="text-white/70 mt-2">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <article className="bg-white/5 border border-white/10 backdrop-blur rounded-xl p-5">
              ...
              <h4 className="font-semibold text-lg text-white/90">CNN on 8×8 Glyphs</h4>
              <p className="text-white/70 text-sm mt-2">
            ...
            <article className="bg-white/5 border border-white/10 backdrop-blur rounded-xl p-5">
              ...
              <h4 className="font-semibold text-lg text-white/90">Emerald Cleaver Mod</h4>
              <p className="text-white/70 text-sm mt-2">
            ...
            <article className="bg-white/5 border border-white/10 backdrop-blur rounded-xl p-5">
              ...
              <h4 className="font-semibold text-lg text-white/90">This Website</h4>
              <p className="text-white/70 text-sm mt-2">
        ...
        <div className="space-y-6">
          <div>
            <div className="text-xs uppercase tracking-wider text-white/60 mb-1">Discipline</div>
            <h3 className="text-3xl font-bold text-white/95">Music</h3>
            <p className="text-white/70 mt-2">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <article className="bg-white/5 border border-white/10 backdrop-blur rounded-xl p-5">
              ...
              <h4 className="font-semibold text-lg text-white/90">B Phrygian Dominant EP</h4>
            ...
            <article className="bg-white/5 border border-white/10 backdrop-blur rounded-xl p-5">
              ...
              <h4 className="font-semibold text-lg text-white/90">Algorithmic Sketches</h4>
            ...
            <article className="bg-white/5 border border-white/10 backdrop-blur rounded-xl p-5">
              ...
              <h4 className="font-semibold text-lg text-white/90">School Showcase Performance</h4>
        ...
        <div className="space-y-6">
          <div>
            <div className="text-xs uppercase tracking-wider text-white/60 mb-1">Discipline</div>
            <h3 className="text-3xl font-bold text-white/95">Mandarin</h3>
            <p className="text-white/70 mt-2">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <article className="bg-white/5 border border-white/10 backdrop-blur rounded-xl p-5">
              ...
              <h4 className="font-semibold text-lg text-white/90">AI Literacy Translations</h4>
            ...
            <article className="bg-white/5 border border-white/10 backdrop-blur rounded-xl p-5">
              ...
              <h4 className="font-semibold text-lg text-white/90">Yunnan Cultural Notes (中英)</h4>
            ...
            <article className="bg-white/5 border border-white/10 backdrop-blur rounded-xl p-5">
              ...
              <h4 className="font-semibold text-lg text-white/90">Heritage Tutoring</h4>
      ...
      {/* About Section */}
      <section id="about" className="relative space-y-12 pt-20 pb-16 scroll-mt-20">
        <h2 className="text-4xl sm:text-5xl font-bold text-white/95">About</h2>
        
        <div className="space-y-6">
          <div className="bg-white/5 border border-white/10 backdrop-blur rounded-xl p-8">
            <h3 className="text-3xl sm:text-4xl font-bold text-white/95">Harrison R. Green</h3>
        ...
        <div className="space-y-4">
          <h3 className="text-2xl font-bold text-white/95">Information</h3>
      ...
      {/* Contact Section */}
      <section id="contact" className="relative space-y-4 pt-20 pb-32 scroll-mt-20">
