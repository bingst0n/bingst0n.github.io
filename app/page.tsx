...
export default function Home() {
  return (
    <div className="relative">
      {/* Fixed Decorative graphics - don't scroll */}
      <div className="pointer-events-none fixed inset-0 z-0">
        <Image
          ...
          width={260}
          height={260}
          className="fixed opacity-25 drift-slow select-none glow-soft hidden landscape:block" style={{top: '30vh', left: '1vw', width: 'clamp(120px, 18vw, 280px)', height: 'auto'}}
          priority={false}
        />
        <Image
          ...
          width={220}
          height={220}
          className="fixed opacity-25 drift-slowest select-none glow-soft hidden landscape:block" style={{top: '37vh', right: '1vw', width: 'clamp(100px, 16vw, 260px)', height: 'auto'}}
          priority={false}
        />
        <Image
          ...
          width={200}
          height={200}
          className="fixed opacity-25 drift-slower select-none glow-soft hidden landscape:block" style={{bottom: '35vh', left: '1vw', width: 'clamp(100px, 15vw, 240px)', height: 'auto'}}
          priority={false}
        />
        <Image
          ...
          width={240}
          height={240}
          className="fixed opacity-25 drift-slow select-none glow-soft hidden landscape:block" style={{bottom: '35vh', right: '1vw', width: 'clamp(120px, 18vw, 280px)', height: 'auto'}}
          priority={false}
        />
        <div className="fixed" style={{bottom: '8px', left: '50%', transform: 'translateX(-50%)'}}>
          <Image
      ...
      {/* Hero Section */}
      <section className="relative isolate mx-auto max-w-4xl px-4 sm:px-6 min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="mt-8 flex flex-wrap gap-4 justify-center">
            <a href="#projects-skills" className="inline-flex items-center rounded-full bg-white/10 px-5 py-2.5 text-white/90 hover:bg-white/15 border border-white/15 transition-colors scroll-smooth">
              Projects & Skills
            </a>
      ...
      <section id="projects-skills" className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 py-24 space-y-16">
      ...
      {/* About Section */}
      <section id="about" className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 py-24 space-y-12">
        <div className="space-y-6">
      ...
      {/* Contact Section */}
      <section id="contact" className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 py-24 space-y-12">
        <div className="space-y-4">
        ...
        <div className="text-center pt-8">
          <a href="#" className="text-white/70 hover:text-white/90 hover:underline transition-colors">↑ Back to Top</a>
        </div>
      </section>
    </div>
  );
